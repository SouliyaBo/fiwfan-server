...
import { getCreators, getCreatorById, updateCreatorProfile, getRecommendedCreators, getZoneStats, updateCreatorVerification, submitKyc, getKycStatus, getCreatorsForSitemap } from '../controllers/creator.controller';

const router = Router();

router.get('/', optionalAuthenticate, getCreators);
router.get('/sitemap', getCreatorsForSitemap);
